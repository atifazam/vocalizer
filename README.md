...
1. Download and include `vocalizer.min.js` and `vocalizer.min.css` into your website. Make sure to include `vocalizer.min.js` right before the closing `</body>` tag.
